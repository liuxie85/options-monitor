...
- 当前代码已经完成绝大多数治理：`scripts/agent_plugin/config.py`、`src/interfaces/cli/main.py`、`src/application/config_validator.py`、`scripts/send_if_needed.py`、`src/application/multi_account_tick.py` 等都默认使用 `config.us.json` / `config.hk.json`。
