...
function globalFormFromSummary(summary){
  ...
  return {
    ...
    closeAdvice: {
      ...
      max_items_per_account: closeAdvice.max_items_per_account == null ? '5' : String(closeAdvice.max_items_per_account),
      max_spread_ratio: closeAdvice.max_spread_ratio == null ? '0.4' : String(closeAdvice.max_spread_ratio),
      strong_remaining_annualized_max: closeAdvice.strong_remaining_annualized_max == null ? '0.08' : String(closeAdvice.strong_remaining_annualized_max),
      medium_remaining_annualized_max: closeAdvice.medium_remaining_annualized_max == null ? '0.12' : String(closeAdvice.medium_remaining_annualized_max),
    },
    notifications: {
