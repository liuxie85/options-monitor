...
def _event_key(event: dict[str, Any], position_side: str | None = None) -> tuple:
    return (
...
def _event_detail_sort_key(row: dict[str, Any]) -> tuple:
    return (
    ...
    *,
    ...
    for event in events:
        ...
        for lot in matches:
            ...
            lot["close_amount"] = _round_money(lot.get("close_amount") + close_amount)
            lot["realized_pnl"] = _round_money(lot.get("realized_pnl") + realized_pnl)
