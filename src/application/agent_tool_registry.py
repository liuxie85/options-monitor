...
AGENT_TOOL_DEFINITIONS: tuple[AgentToolDefinition, ...] = (
    ...
    AgentToolDefinition(
        ...
        examples=(
            ...
            {"input": {"version": "1.2.3", "apply": True, "confirm": True}},
        ),
    ),
    AgentToolDefinition(
    ...
    AgentToolDefinition(
        ...
        input_schema={
            "runs_root": "optional run history root; defaults to output_runs",
            "profile_path": "optional OpenClaw/service profile JSON path; aliases openclaw_profile_path",
            "openclaw_profile_path": "optional OpenClaw/service profile JSON path",
    ...
    AgentToolDefinition(
        ...
        input_schema={
            ...
            "file": "optional explicit log file path; aliases log_file",
